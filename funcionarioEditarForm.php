...
//Cria o SQL (consulte tudo da tabela funcionarios)
$sql="SELECT * FROM funcionarios WHERE ID_funcionario=$campoid";
...
<html>
    ...
    <body>
        <form action="funcionarioEditar.php" method="post">
            <h3>Funcionário Id: <?php echo $row["ID_funcionario"]; ?></h3>
        ...
        <?php }else{ ?>
            <input type="radio" name="acesso" value="Personal" checked="true"><label>Personal</label> 
