    ...
    <table>
      <tr>
        ...
        <th colspan="2">Ações</td>
            ...
            echo "<tr><td>". $row["ID_aluno"] . "</td><td>". $row["Nome"] . "</td><td>". $row["Email"] . "</td><td>". $row["Senha"] . "</td><td>". $row["Acesso"] . "</td>";
            echo "<td><a href='alunoEditarForm.php?id=". $row["ID_aluno"] . "'><img src='images/editar.svg' alt='Editar Usuário'></a></td><td><a href='alunoExcluir.php?id=". $row["ID_aluno"] . "'><img src='images/excluir.svg' alt='Excluir Usuário'></a></td></tr>";
        }

        ?>
    </table>
    <br><a href="alunoCadastrarTela.php"><img src='images/adicionar.svg' alt='Adicionar Usuário'></a>
  </div>
</body>
